...
class Xlsx2csv:
    ...
    def __init__(self, xlsxfile, **options):
        ...
        options.setdefault("inmemory", False)
    ...
    def parse(self, filehandle):
        ...
        if len(fileVersion) == 0:
            ...
            try:
                if workbookDoc.firstChild.namespaceURI:
                    self.appName = \
                        workbookDoc.firstChild.getElementsByTagNameNS(workbookDoc.firstChild.namespaceURI,
                                                                      "fileVersion")[
